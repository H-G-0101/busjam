...
.5;this.pnlTop.isPointerBlocker=!1;this.pnlTop.isHitTestVisible=!1;this.pnlTop.leftInPixels=0;this.pnlTop.topInPixels=0;this.pnlTop.thickness=0;this.pnlTop.highlightLineWidth=0;this.pnlTop.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.pnlTop.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.pnlTop.heightInPixels=120;a.addControl(this.pnlTop);this.pnlTop.resize=function(b,e){var f=.09*e;e>b&&(f=.09*e);this.heightInPixels=f+10};this.txtLevel=new BABYLON.GUI.TextBlock("txtLevel");this.txtLevel.textWrapping=!1;this.txtLevel.shadowBlur=0;this.txtLevel.fontFamily="gamefont";this.txtLevel.fontSize=44;this.txtLevel.color="white";this.txtLevel.outlineWidth=7;this.txtLevel.outlineColor="#1b3a78";try{this.txtLevel.text=STR("LEVEL")+" "+(ActiveLevel+1)}catch(e){this.txtLevel.text="LEVEL "+(ActiveLevel+1)}this.txtLevel.textHorizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtLevel.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtLevel.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.txtLevel.topInPixels=22;this.txtLevel.isPointerBlocker=!1;this.txtLevel.isHitTestVisible=!1;this.pnlTop.addControl(this.txtLevel);return this.pnlTop},createSettingsButton:function(a){this.btnSettings=

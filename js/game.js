function __bjAssetV(f){return "?v="+("pak1.png"===f?"cidi141":"cidi78")}
!function(){
/*!
...
/* ===== CiDi Ads Bridge (ex-rede de ads externa) ===== *//* SDK da CiDi: app.cidi.games/sdk/cidi-sdk.js -> expoe window.CiDiSDK *//* Mostra rewarded real. onResult(true)=concede premio (success===true) / onResult(false)=sem ad, fechou ou erro. */function showRewardedAd(onResult){var done=!1,fire=function(ok,why){if(done)return;done=!0;try{window.__bjAdLog&&window.__bjAdLog("reward "+(ok?"CONCEDIDO":"sem premio"),!!ok,why||"");}catch(e){}onResult(!!ok);};var isDev=(location.protocol==="file:"||location.hostname==="localhost"||location.hostname==="127.0.0.1");var hasSDK=!1;try{hasSDK=!!(window.CiDiSDK&&typeof window.CiDiSDK.showRewardedAd==="function");}catch(e){}var logged=!1;try{logged=!!(window.__bjCidi&&window.__bjCidi.status&&window.__bjCidi.status().loggedIn);}catch(e){}if(hasSDK&&(logged||isDev)){try{window.__bjAdLog&&window.__bjAdLog("showRewardedAd() chamado",null,"sem args (default 300s) | logado="+logged);}catch(e){}try{window.CiDiSDK.showRewardedAd().then(function(r){var ok=!!(r&&r.success===!0);try{window.__bjAdLog&&window.__bjAdLog("resolved",ok,"raw="+JSON.stringify(r));}catch(e){}fire(ok,ok?"success=true":"success!=true");}).catch(function(e){try{window.__bjAdLog&&window.__bjAdLog("rejected (catch)",false,(e&&(e.code||e.message))?((e.code||"")+" "+(e.message||"")):(""+e));}catch(_){}fire(!1,"rejected");});/* trava de seguranca ACIMA do timeout do SDK (nao corta ad em andamento) */setTimeout(function(){fire(!1,"safety-timeout 360s");},360000);}catch(e){try{window.__bjAdLog&&window.__bjAdLog("excecao",false,(""+e));}catch(_){}fire(!1,"exception");}return;}/* dev: concede p/ teste */if(isDev){try{window.__bjAdLog&&window.__bjAdLog("dev fallback (localhost)",true,"concede p/ teste");}catch(e){}fire(!0,"dev");return;}/* sem SDK ou sem login -> sem premio (rapido, nao pendura o jogo) */if(!hasSDK){try{window.__bjAdLog&&window.__bjAdLog("CiDiSDK ausente",false,"producao sem SDK/Pi Browser");}catch(e){}fire(!1,"no-sdk");}else{try{window.__bjAdLog&&window.__bjAdLog("login CiDi nao concluido",false,"ad bloqueado ate logar (loggedIn=false)");}catch(e){}fire(!1,"no-login");}}/* Shim que mantem os 16 call-sites legados (gdsdk.showAd / preloadAd) funcionando. */window.gdsdk={preloadAd:function(){return Promise.resolve();},showAd:function(type){if(type==="rewarded"){return new Promise(function(resolve,reject){showRewardedAd(function(ok){if(ok){if(gdist_ad_clbck&&gdist_ad_clbck[0]){try{gdist_ad_clbck[0].call(gdist_ad_clbck[1]);}catch(e){}}gdist_ad_clbck=gdist_ad_clbck_fail=!1;resolve();}else{reject(new Error("no-ad"));}});});}/* interstitial: CiDi nao usa -> no-op seguro */return Promise.resolve();}};var gamedist_rewAdAvailable=!1;
...
function getUnusedSpace(){var a=Resolution.WIDTH,b=Resolution.HEIGHT;const e=engine.getRenderWidth(),f=engine.getRenderHeight();if(e>f){var h=Math.min(e/a,f/b);b*=h;a=(e-a*h)/2;e>1.75*f&&(a*=.87);b=(f-b)/2;return{isLandscape:!0,horizontalFree:Math.floor(a),verticalFreeTop:Math.floor(b),scale:h,renderWidth:e,renderHeight:f}}h=Math.min(e/a,f/b);return{isLandscape:!1,horizontalFree:0,verticalFreeTop:Math.floor((f-b*h)/2),scale:h,renderWidth:e,renderHeight:f}};var POPUP_TRANSITION_DURATION=400,SCENE_TRANSITION_DURATION=250;RewardAds={showRewAd:function(a,b,e,f){const h=b;b=function(){inlHelper.rewardAds._applyRewardedAdCooldownSmart();inlHelper.rewardAds.rewAdTriggered();"function"===typeof h&&h.call(f)};inlHelper.rewardAds.test?(console.warn("TEST ADS ALLOWED !"),inlHelper.rewardAds.showFakeRewAd(b,e,f)):gamedist_showRewAd(b,e,f)}};window.__bjWatchAd=function(cb){try{var _f=!1;RewardAds.showRewAd(activeScene.scene,function(){if(_f)return;_f=!0;cb&&cb(!0)},function(){if(_f)return;_f=!0;cb&&cb(!1)},null)}catch(e){cb&&cb(!1)}};window.__bjAddCoins=function(n){try{screenTopPanel.incCash(n|0)}catch(e){}};window.__bjBoosterResume=function(){try{activeScene.gamePaused=!1;screenGame.enableControls();Buttons.enabled=!0}catch(e){}};window.__bjBoosterPay=function(type,price,cb){try{if(screenTopPanel.purchaseForCash(price|0,!1)){window.__bjBoosterResume();screenGame.runBooster(type);cb&&cb(!0)}else{cb&&cb(!1)}}catch(e){cb&&cb(!1)}};window.__bjBoosterAdRun=function(type,cb){try{Buttons.enabled=!1;var _f=!1;RewardAds.showRewAd(activeScene.scene,function(){if(_f)return;_f=!0;window.__bjBoosterResume();screenGame.runBooster(type);cb&&cb(!0)},function(){if(_f)return;_f=!0;window.__bjBoosterResume();cb&&cb(!1)},null)}catch(e){window.__bjBoosterResume();cb&&cb(!1)}};window.__bjBoosterClose=function(){window.__bjBoosterResume()};window.__bjSpotResume=function(){try{activeScene.gamePaused=!1;activeScene.gameRunning=!0;screenGame.enableControls();Buttons.enabled=!0}catch(e){}};window.__bjSpotGrant=function(){try{screenGame.spotPurchased(screenPurchaseSpot.spot)}catch(e){}};window.__bjSpotAd=function(cb){try{Buttons.enabled=!1;var _f=!1;RewardAds.showRewAd(activeScene.scene,function(){if(_f)return;_f=!0;window.__bjSpotGrant();window.__bjSpotResume();cb&&cb(!0)},function(){if(_f)return;_f=!0;window.__bjSpotResume();cb&&cb(!1)},null)}catch(e){window.__bjSpotResume();cb&&cb(!1)}};window.__bjSpotPay=function(price,cb){try{if(screenTopPanel.purchaseForCash(price|0,!1)){window.__bjSpotGrant();window.__bjSpotResume();cb&&cb(!0)}else cb&&cb(!1)}catch(e){cb&&cb(!1)}};window.__bjSpotClose=function(){window.__bjSpotResume()};window.__bjSetGetMusic=function(){try{return Number(soundManager.musicVolume)>0}catch(e){try{return screenSettings.sldrMusicVolume.value>0}catch(e2){return true}}};window.__bjSetGetSound=function(){try{return Number(soundManager.soundVolume)>0}catch(e){try{return screenSettings.sldrSoundsVolume.value>0}catch(e2){return true}}};window.__bjSetGetLang=function(){try{return Languages.instance.language}catch(e){return"en"}};window.__bjSetToggleMusic=function(){try{var on=!window.__bjSetGetMusic();var v=on?((Number(SavedMusicVolume)>0)?Number(SavedMusicVolume)/100:1):0;soundManager.setMusicVolume(v);try{screenSettings.sldrMusicVolume.value=v*100}catch(e2){}}catch(e){}return window.__bjSetGetMusic()};window.__bjSetToggleSound=function(){try{var on=!window.__bjSetGetSound();var v=on?((Number(SavedSoundVolume)>0)?Number(SavedSoundVolume)/100:1):0;soundManager.setSoundsVolume(v);try{screenSettings.sldrSoundsVolume.value=v*100}catch(e2){}}catch(e){}return window.__bjSetGetSound()};window.__bjSetGetMusicVol=function(){try{return Math.round(Number(soundManager.musicVolume)*100)}catch(e){return 100}};window.__bjSetGetSoundVol=function(){try{return Math.round(Number(soundManager.soundVolume)*100)}catch(e){return 100}};window.__bjSetMusicVol=function(p){try{p=Math.max(0,Math.min(100,Number(p)||0));if(p<1.5)p=0;if(p>0)SavedMusicVolume=p;soundManager.setMusicVolume(p/100);try{screenSettings.sldrMusicVolume.value=p}catch(e2){}try{GameData.Save()}catch(e3){}}catch(e){}};window.__bjSetSoundVol=function(p){try{p=Math.max(0,Math.min(100,Number(p)||0));if(p<1.5)p=0;if(p>0)SavedSoundVolume=p;soundManager.setSoundsVolume(p/100);try{screenSettings.sldrSoundsVolume.value=p}catch(e2){}try{GameData.Save()}catch(e3){}}catch(e){}};window.__bjStr=function(k){try{return STR(k)}catch(e){return null}};window.__bjFailRetry=function(){if(!Buttons.enabled)return;window.__bjRetryShuffle=(window.__bjRetryShuffle||0)+1;try{window.__bjHideFail&&window.__bjHideFail()}catch(e){}screenLevelFailed.onRestartPressed()};window.__bjContinueRetry=function(){if(!Buttons.enabled)return;window.__bjRetryShuffle=(window.__bjRetryShuffle||0)+1;try{window.__bjHideContinue&&window.__bjHideContinue()}catch(e){}screenContinue.onRestartPressed()};window.__bjContinueFree=function(){if(!Buttons.enabled)return;Buttons.enabled=!1;try{window.__bjAdLoadShow&&window.__bjAdLoadShow()}catch(e){}var _cf=!1;function _hide(){if(_cf)return;_cf=!0;try{window.__bjAdLoadHide&&window.__bjAdLoadHide()}catch(e){}}try{RewardAds.showRewAd(activeScene.scene,function(){_hide();try{window.__bjHideContinue&&window.__bjHideContinue()}catch(e){}screenContinue.hideScene(function(){screenGame.enableControls();screenGame.newSpotPurchased();activeScene.gamePaused=!1;activeScene.gameRunning=!0;Buttons.enabled=!0})},function(){_hide();Buttons.enabled=!0},null)}catch(e){_hide();Buttons.enabled=!0}};window.__bjCompleteAd=function(amount){if(!Buttons.enabled)return;Buttons.enabled=!1;screenLevelCompletedADs.resultPriceClaimed=!0;try{window.__bjAdLoadShow&&window.__bjAdLoadShow()}catch(e){}try{RewardAds.showRewAd(activeScene.scene,function(){try{window.__bjAdLoadHide&&window.__bjAdLoadHide()}catch(e){}screenLevelCompletedADs._claimRewardAndStartNextLevel(amount|0)},function(){try{window.__bjAdLoadHide&&window.__bjAdLoadHide()}catch(e){}Buttons.enabled=!0;screenLevelCompletedADs.resultPriceClaimed=!1},null)}catch(e){try{window.__bjAdLoadHide&&window.__bjAdLoadHide()}catch(_){}Buttons.enabled=!0}};window.__bjCompleteContinue=function(){if(!Buttons.enabled)return;Buttons.enabled=!1;screenLevelCompletedADs._claimRewardAndStartNextLevel(0)};window.__bjSetLangNext=function(){try{Buttons.enabled=true;screenSettings.onNextLangPressed()}catch(e){}return window.__bjSetGetLang()};window.__bjSetLangPrev=function(){try{Buttons.enabled=true;screenSettings.onPrevLangPressed()}catch(e){}return window.__bjSetGetLang()};window.__bjCoinAd=function(amount,cb){try{var _f=!1;RewardAds.showRewAd(activeScene.scene,function(){if(_f)return;_f=!0;try{screenTopPanel.incCash(amount|0)}catch(e){}cb&&cb(!0)},function(){if(_f)return;_f=!0;cb&&cb(!1)},null)}catch(e){cb&&cb(!1)}};var Languages=function(a){if(null!=Languages.instance)return Languages.instance;Languages.instance=this;Languages.instance.language="en";this.gameTextsParsed=null;this.xml=a;this.gameTextsLists=[];a=this.xml.getElementsByTagName("string");for(var b=0;b<a.length;b++){null==this.gameTextsLists[a.item(b).getAttribute("id")]&&(this.gameTextsLists[a.item(b).getAttribute("id")]=[]);for(var e=0;e<LANGUAGES.length;e++)0<a.item(b).getElementsByTagName(LANGUAGES[e]).length&&(this.gameTextsLists[a.item(b).getAttribute("id")][LANGUAGES[e]]=
a.item(b).getElementsByTagName(LANGUAGES[e])[0].textContent.replace(/\\n/g,"\n"))}},LANGUAGES="en de es fr it pt ru zh vi ko".split(" "),LANGUAGE_NAMES=[];LANGUAGE_NAMES.en="ENGLISH";LANGUAGE_NAMES.de="DEUTSCH";LANGUAGE_NAMES.es="ESPA\u00d1OL";LANGUAGE_NAMES.fr="FRAN\u00c7AIS";LANGUAGE_NAMES.it="ITALIANO";LANGUAGE_NAMES.pt="PORTUGU\u00caS";LANGUAGE_NAMES.ru="\u0420\u0423\u0421\u0421\u041a\u0418\u0419";LANGUAGE_NAMES.zh="\u4e2d\u6587";LANGUAGE_NAMES.vi="Ti\u1ebfng Vi\u1ec7t";LANGUAGE_NAMES.ko="\ud55c\uad6d\uc5b4";Languages.instance=null;Languages.prototype={};
...
GameData.Load=function(){GameData.Reset();var a=getUrlParameterByName("reset");null!=a&&"true"===a.toLowerCase()&&GameData.Save();a=null;try{a=JSON.parse(localStorage.getItem(GameData.ProfileName))}catch(b){}try{a.DataVersion!=DataVersion?GameData.Save():(SelectedLanguage=a.SelectedLanguage,PlayerCash=(/tempToken=/.test(location.search)||/tempToken=/.test(location.hash))?a.PlayerCash:a.PlayerCash,ActiveLevel=a.ActiveLevel,SavedGame=a.SavedGame,SavedSoundVolume=a.SavedSoundVolume,SavedMusicVolume=a.SavedMusicVolume,GameQuality=a.GameQuality,OnboardingStep=a.OnboardingStep)}catch(b){GameData.Reset()}try{window.__bjCidi&&window.__bjCidi.reconcileMedal((ActiveLevel||0)+1);}catch(__e){}null!=
...
file:"people.png",type:"texture"},{root:"assets/imgs/",file:"digits.json",type:"json"},{root:"assets/imgs/",file:"digits.png",type:"texture"},{root:"assets/imgs/",file:"flare.png",type:"texture"},{root:"assets/imgs/",file:"expl.png",type:"texture"},{root:"assets/models/",file:"parking_field.glb",type:"model"},{root:"assets/models/",file:"entrance.glb",type:"model"},{root:"assets/models/",file:"queue_panel.glb",type:"model"},{root:"assets/models/",file:"standunlock.glb",type:"model"},{root:"assets/models/",file:"car.glb",type:"model"},{root:"assets/models/",
...
type:"audio"},{root:"assets/audio/",file:"bus_engine.mp3",type:"audio"},{root:"assets/audio/",file:"button.mp3",type:"audio"},{root:"assets/audio/",file:"buy.mp3",type:"audio"},{root:"assets/audio/",file:"coin.mp3",type:"audio"},{root:"assets/audio/",file:"count0.mp3",type:"audio"},{root:"assets/audio/",file:"count321.mp3",type:"audio"},{root:"assets/audio/",file:"lost.mp3",type:"audio"},{root:"assets/audio/",file:"music_ingame.mp3",type:"audio"},{root:"assets/audio/",file:"music_menu.mp3",src:"music_ingame.mp3",type:"audio"},
...
BABYLON.Engine.audioEngine.unlock(),BABYLON.Engine.audioEngine&&(BABYLON.Engine.audioEngine.audioContext.suspend(),BABYLON.Engine.audioEngine.audioContext.resume()),soundManager.playSound("button"),this.imgInlogicSplash.isVisible?Buttons.enabled=!0:(screenTopPanel.showScene(),window.__bjShowCoinBtn&&window.__bjShowCoinBtn(),screenBackground.guiRoot.isVisible=!0,screenGame.guiRoot.isVisible=!0,Buttons.enabled=!0,screenGame.rootNode.setEnabled(!0),screenGame.resetGame(),screenGame.updateData(),soundManager.playMusic("music_ingame"),Buttons.enabled=
...
BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.btnSettings.topInPixels=14*Resolution.SCALE;this.btnSettings.leftInPixels=0;this.btnSettings.isHitTestVisible=!1;this.btnSettings.isFocusInvisible=!0;a.addControl(this.btnSettings);this.btnSettings.isVisible=!1;this.btnSettings.isHitTestVisible=!1;this.btnSettings.isPointerBlocker=!1;SetImageFromSpritesheet(this.btnSettings.children[0],getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"gear_new.png");this.btnSettings.children[0].widthInPixels=136;this.btnSettings.children[0].heightInPixels=142;ResetGuiButtonAppearance(this.btnSettings,136,142);this.btnSettings.onPointerClickObservable.add(this.onSettingsPressed);
...
BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;this.pnlCoins.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.pnlCoins.leftInPixels=b;this.pnlCoins.topInPixels=e;this.pnlCoins.thickness=0;this.pnlCoins.heightInPixels=100;this.pnlCoins.widthInPixels=350;this.pnlCoins.isPointerBlocker=!1;this.pnlCoins.isHitTestVisible=!1;this.pnlCoins.clipContent=!1;this.pnlCoins.clipChildren=!1;a.addControl(this.pnlCoins);this.pnlCoins.background="#16314f";this.pnlCoins.cornerRadius=50;this.pnlCoins.thickness=4;this.pnlCoins.color="#5C7FA8";this.pnlCoins.isPointerBlocker=!0;this.pnlCoins.isHitTestVisible=!0;this.pnlCoins.onPointerClickObservable.add(function(){try{soundManager.playSound("button")}catch(e){}window.__bjShowFreeCoins&&window.__bjShowFreeCoins()});this.imgCoinsBG=new BABYLON.GUI.Image("imgCoinsBG");this.imgCoinsBG.transformCenterX=
.5;this.imgCoinsBG.transformCenterY=.5;this.imgCoinsBG.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgCoinsBG.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgCoinsBG.isPointerBlocker=!1;this.imgCoinsBG.isHitTestVisible=!1;this.imgCoinsBG.leftInPixels=0;this.imgCoinsBG.topInPixels=0;this.pnlCoins.addControl(this.imgCoinsBG);this.imgCoinsBG.source="assets/imgs/coins_pill.png?v=cidi80";this.imgCoinsBG.widthInPixels=360;this.imgCoinsBG.heightInPixels=140;this.imgCoinsBG.alpha=0;this.txtCoinsVal=
new BABYLON.GUI.TextBlock("txtCoinsVal");this.txtCoinsVal.textWrapping=!1;this.txtCoinsVal.shadowBlur=0;this.txtCoinsVal.transformCenterX=.5;this.txtCoinsVal.transformCenterY=.5;this.txtCoinsVal.widthInPixels=180;this.txtCoinsVal.heightInPixels=90;this.txtCoinsVal.leftInPixels=16;this.txtCoinsVal.topInPixels=-16;this.txtCoinsVal.fontFamily="gamefont";this.txtCoinsVal.fontSize=42;this.txtCoinsVal.color="#ffffff";this.txtCoinsVal.outlineColor="#0a1423";this.txtCoinsVal.outlineWidth=4;this.txtCoinsVal.textVerticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtCoinsVal.text="1523";this.txtCoinsVal.textHorizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtCoinsVal.isPointerBlocker=!1;this.txtCoinsVal.isHitTestVisible=
!1;this.pnlCoins.addControl(this.txtCoinsVal);this.coinDisc=new BABYLON.GUI.Ellipse("coinDisc");this.coinDisc.widthInPixels=120;this.coinDisc.heightInPixels=120;this.coinDisc.background="#F2B100";this.coinDisc.thickness=7;this.coinDisc.color="#ffffff";this.coinDisc.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;this.coinDisc.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.coinDisc.leftInPixels=-22;this.coinDisc.isPointerBlocker=!1;this.coinDisc.isHitTestVisible=!1;this.pnlCoins.addControl(this.coinDisc);this.coinShine=new BABYLON.GUI.Ellipse("coinShine");this.coinShine.widthInPixels=36;this.coinShine.heightInPixels=22;this.coinShine.background="rgba(255,255,255,0.6)";this.coinShine.thickness=0;this.coinShine.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;this.coinShine.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.coinShine.leftInPixels=8;this.coinShine.topInPixels=-28;this.coinShine.isPointerBlocker=!1;this.coinShine.isHitTestVisible=!1;this.pnlCoins.addControl(this.coinShine);this.btnPlusCoins=new BABYLON.GUI.Ellipse("btnPlusCoins");this.btnPlusCoins.widthInPixels=58;this.btnPlusCoins.heightInPixels=58;this.btnPlusCoins.background="#3DBA4A";this.btnPlusCoins.thickness=4;this.btnPlusCoins.color="#ffffff";this.btnPlusCoins.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;this.btnPlusCoins.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.btnPlusCoins.leftInPixels=-8;this.btnPlusCoins.isPointerBlocker=!1;this.btnPlusCoins.isHitTestVisible=!1;this.pnlCoins.addControl(this.btnPlusCoins);this.txtPlus=new BABYLON.GUI.TextBlock("txtPlus","+");this.txtPlus.fontFamily="gamefont";this.txtPlus.fontSize=46;this.txtPlus.color="#ffffff";this.txtPlus.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;this.txtPlus.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtPlus.leftInPixels=-21;this.txtPlus.topInPixels=-4;this.txtPlus.isPointerBlocker=!1;this.txtPlus.isHitTestVisible=!1;this.pnlCoins.addControl(this.txtPlus);this.pnlCoins.alpha=0;this.pnlCoins.isHitTestVisible=!1;this.pnlCoins.isPointerBlocker=!1;this.pnlCoins.resize=function(f,h){this.scaleX=this.scaleY=.76*ScreenTopPanel.instance.btnSettings.scaleY;this.topInPixels=Math.round(ScreenTopPanel.instance.pnlTop.heightInPixels*0.14);this.leftInPixels=-Math.round(220*this.scaleX)}},createVersionInfo:function(){this.txtVersion=new BABYLON.GUI.TextBlock;this.txtVersion.textWrapping=!0;this.txtVersion.leftInPixels=-5;this.txtVersion.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;this.txtVersion.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_BOTTOM;this.txtVersion.textHorizontalAlignment=
BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;this.txtVersion.textVerticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_BOTTOM;this.txtVersion.color="white";this.txtVersion.text=" v"+GameData.BuildVersion+" [ "+GameData.BuildString+" ]";this.txtVersion.outlineWidth=3;this.txtVersion.outlineColor="#333333EE";this.txtVersion.fontSize="17px";this.txtVersion.isPointerBlocker=!1;this.txtVersion.isHitTestVisible=!1;this.pnlRoot.addControl(this.txtVersion)},onSettingsPressed:function(){if(Buttons.enabled){soundManager.playSound("button");if(window.__bjShowSettings){window.__bjShowSettings()}}},onFullscreenPressed:function(){Buttons.enabled&&(soundManager.playSound("button"),fullscreenToggle(),this.btnFullscreen.updateIcon())},incCash:function(a){a=Math.max(0,a|0);PlayerCash+=a;GameData.Save();this.pnlCoins.resize(engine.getRenderWidth(),
...
DURATION_BOOSTER_SHAKE),soundManager.playSound("negative_buy"),"sort"==a&&(b=this.pnlBoosters.getBoosterByName(a).transformedMeasure,screenParticles.textParticles.CreateTextParticle1(0,b.top-engineRenderHeight/2,STR("NO_CAR_TO_SORT"),45,"#FFFFFF",1))))},purchaseBooster:function(a){activeScene.gamePaused=!0;screenGame.disableControls();if(window.__bjShowBoosterModal&&(a=="shuffle"||a=="sort")){window.PlayerCash=PlayerCash;window.__bjShowBoosterModal(a,BoosterPrices[a],STR(a.toUpperCase()),STR(a.toUpperCase()+"_DESC"),STR("FREE"),STR("WATCH_AD"));return}screenPurchaseBooster.setBooster(a);screenPurchaseBooster.setPrice(BoosterPrices[a]);screenPurchaseBooster.showScene()},purchaseSpot:function(a){null!=a.icon&&a.icon.isVisible&&
...
null;k.parkingSpot=null;k.parent=this.busesNode;k.computeWorldMatrix(!0);k.busTop=null;k.vanTop=null;k.carTop=null;void 0!==f&&(k.rotation=f);void 0!==h&&(k.rotationQuaternion=h);e=500<getRandomUIntWithSeed(1E3,this.levelSeed*this.buses.length);2==b&&(e?(e=this.spawnModel(k,"van").rootNodes[0],m=.0055,e.scaling=v3(m,m,m),e.getChildMeshes(!1).forEach(function(cm){cm.alwaysSelectAsActiveMesh=!0}),m=traverseFindChildNodeByName(e._children[0],"van_body_top"),f=traverseFindChildNodeByName(e._children[0],"van_bottom"),e=traverseFindChildNodeByName(e._children[0],"_arrow"),m.isPickable=
!0,f.isPickable=!0,e.isPickable=!0,m.bus3d=k,f.bus3d=k,e.bus3d=k,k.isVisible=!1,k.vanTop=m,k.vanBottom=f,k.vanArrow=e,k.capacity=6,k.freeCapacity=6):(e=this.spawnModel(k,"car").rootNodes[0],m=.0055,e.scaling=v3(m,m,m),e.getChildMeshes(!1).forEach(function(cm){cm.alwaysSelectAsActiveMesh=!0}),m=traverseFindChildNodeByName(e._children[0],"car_body_top"),f=traverseFindChildNodeByName(e._children[0],"car_bottom"),e=traverseFindChildNodeByName(e._children[0],"_arrow"),m.isPickable=!0,f.isPickable=!0,e.isPickable=!0,m.bus3d=k,f.bus3d=k,e.bus3d=k,k.isVisible=!1,k.carTop=m,k.carBottom=
f,k.carArrow=e,k.capacity=4,k.freeCapacity=4),k.peopleOnboard=[]);3==b&&(e=this.spawnModel(k,"bus").rootNodes[0],m=.0055,e.scaling=v3(m,m,m),e.getChildMeshes(!1).forEach(function(cm){cm.alwaysSelectAsActiveMesh=!0}),b=traverseFindChildNodeByName(e._children[0],"bus_body_top"),m=traverseFindChildNodeByName(e._children[0],"bus_bottom"),e=traverseFindChildNodeByName(e._children[0],"_arrow"),b.isPickable=!0,m.isPickable=!0,e.isPickable=!0,b.bus3d=k,m.bus3d=k,e.bus3d=k,k.isVisible=!1,k.busTop=b,k.busBottom=m,k.busArrow=e,k.capacity=10,k.freeCapacity=10,k.peopleOnboard=[]);this.setBusColor(k,
...
2),e+=" | "},createLevel:function(a,b,e,f){this.onboardingActive=!1;this.onboardingBusId=0;this.levelSeed=Math.pow(100*ActiveLevel,2);var __lvlS=Math.max(0,ActiveLevel-2);this.gridSize=12;this.filterSize=Math.min(11.5,8.5+__lvlS*0.28);this.colors="red green blue teal purple pink orange yellow".split(" ").slice(0,Math.min(8,5+Math.ceil(__lvlS/2)));var h=null;if(Levels.length>ActiveLevel){var m=Levels[ActiveLevel];m.hasOwnProperty("buses")&&(h=m.buses);m.hasOwnProperty("levelSeed")&&(this.levelSeed=m.levelSeed);m.hasOwnProperty("gridSize")&&(this.gridSize=m.gridSize);m.hasOwnProperty("filterSize")&&(this.filterSize=
m.filterSize);m.hasOwnProperty("colors")&&(this.colors=m.colors);m.hasOwnProperty("onboarding")&&(this.onboardingActive=m.onboarding)}void 0!==a&&(this.levelSeed=a);void 0!==b&&(this.gridSize=b);void 0!==e&&(this.filterSize=e);void 0!==f&&(this.colors=f);(window.__bjRetryShuffle&&(h=null,this.levelSeed=Math.abs((this.levelSeed||1)+window.__bjRetryShuffle*7919+13))),null==h&&(h=this.generateLevelBuses(this.levelSeed,this.gridSize,this.filterSize,this.colors));this.createBusesFromArray(h,this.levelSeed,[this.gridSize,this.gridSize]);this.filterBuses(-DegToRad(45),this.filterSize,this.filterSize);this.filterBuses(-DegToRad(45),
...
this.materialPOI,this.parkingSpots[a].position.y=.83,this.parkingSpots[a].layerMask=LAYER_SCREEN_GAME,this.parkingSpots[a].isVisible=PARKING_BLOCKS_VISIBLE,this.parkingSpots[a].position.x=-9,this.parkingSpots[a].position.z=-9,this.parkingSpots[a].rotation.y=DegToRad(135),this.parkingSpots[a].spotFree=!0,this.parkingSpots[a].computeWorldMatrix(!0),this.parkingSpots[a].model=this.spawnModel(this.parkingSpots[a],"stand",null,null,null,v3(BUS_MODEL_SCALE*1.05,BUS_MODEL_SCALE,BUS_MODEL_SCALE*1.18)),this.parkingSpots[a].model.rootNodes[0]._children[0].isPickable=
!0,this.parkingSpots[a].icon=null,this.parkingSpots[a].price=null,3<a){e=200;var f=BABYLON.MeshBuilder.CreatePlane("icon3d",{frontUVs:new BABYLON.Vector4(0,0,1,1)});f.parent=this.parkingSpots[a].model.rootNodes[0];f.scaling=v3(1*e,-1*e,1*e);f.rotation=v3(0,0,0);f.position=v3(0,40,0);f.billboardMode=BABYLON.Mesh.BILLBOARDMODE_ALL;f.layerMask=LAYER_SCREEN_GAME;f.material=this.digitsMaterial.clone();f.material.name="icon3d_material_"+a;f.isPickable=!0;f.renderingGroupId=1;f.parkingSpot=this.parkingSpots[a];
inlHelper.rewardAds.active?this.setupUnlockIcon(f,a):SetTextureFromSpritesheet(f.material.diffuseTexture,getAssetImageFrames("digits"),"stand_coin.png");inlHelper.rewardAds.active||(this.parkingSpots[a].icon=f);inlHelper.rewardAds.active||(e=220,f=BABYLON.MeshBuilder.CreatePlane("price3d",{frontUVs:new BABYLON.Vector4(0,0,1,1)}),f.parent=this.parkingSpots[a].model.rootNodes[0],f.scaling=v3(2*e,1*e,1*e),f.rotation=v3(DegToRad(90),DegToRad(90),0),f.position=
...
b,e,f,h){a.fillStyle="rgb(96, 108, 143)";a.fillRect(0,0,128,64);a.font=b;a.strokeStyle="black";a.lineWidth=10;a.strokeText(h,e,f);a.fillStyle="white";a.fillText(h,e,f)},setupUnlockIcon:function(f,a){try{var slotRoot=this.parkingSpots[a].model.rootNodes[0];var holder=new BABYLON.TransformNode("unlockHolder_"+a,activeScene.scene);holder.parent=slotRoot;holder.position=v3(0,2,0);holder.rotation=v3(0,DegToRad(180),0);holder.scaling=v3(-1,1,1);var inst=AssetLoader.instance.instantiateModel("standunlock.glb",LAYER_SCREEN_GAME);var root=inst.rootNodes[0];root.parent=holder;var kids=root.getChildMeshes(false);var mesh=kids.length?kids[0]:root;for(var i=0;i<kids.length;i++){kids[i].isPickable=!0;kids[i].parkingSpot=this.parkingSpots[a];kids[i].renderingGroupId=0;}mesh.isPickable=!0;mesh.parkingSpot=this.parkingSpots[a];mesh.renderingGroupId=0;this.parkingSpots[a].icon=mesh;this.parkingSpots[a]._unlockRoot=holder;try{var pinTex=new BABYLON.Texture("assets/imgs/unlock_pin.png",activeScene.scene);pinTex.hasAlpha=!0;var pinMat=new BABYLON.StandardMaterial("unlockPinMat_"+a,activeScene.scene);pinMat.diffuseTexture=pinTex;pinMat.useAlphaFromDiffuseTexture=!0;pinMat.emissiveColor=new BABYLON.Color3(1,1,1);pinMat.disableLighting=!0;pinMat.backFaceCulling=!1;pinMat.transparencyMode=1;pinMat.alphaCutOff=.4;pinMat.disableDepthWrite=!0;f.material=pinMat;f.scaling=v3(320,320,320);f.position=v3(0,600,0);f.isPickable=!0;f.parkingSpot=this.parkingSpots[a];f.renderingGroupId=1;this.parkingSpots[a]._unlockPin=f;}catch(e){try{f.dispose();}catch(_){}}}catch(e){try{f.isVisible=!0;}catch(_){}this.parkingSpots[a].icon=f;}},setQueuePanelNumber:function(a){a=leadingZero(a,3);SetTextureFromSpritesheet(this.queuePanelModel.digit1.material.albedoTexture,getAssetImageFrames("digits"),"num_"+a[0]+".png");this.queuePanelModel.digit1.material.markAsDirty();this.queuePanelModel.digit1.material.markDirty(!0);SetTextureFromSpritesheet(this.queuePanelModel.digit2.material.albedoTexture,
...
!0,null!=this.parkingSpots[a].price&&(this.parkingSpots[a].price.isVisible=!0),null!=this.parkingSpots[a]._unlockPin&&(this.parkingSpots[a]._unlockPin.isVisible=!0))},createHighlightLayer:function(){null!=this.highlightLayer&&this.highlightLayer.dispose();this.highlightLayer=new BABYLON.HighlightLayer("highlightLayer",activeScene.scene,{isStroke:!0,mainTextureRatio:.8/Resolution.SCALE});this.highlightLayer.anim1=CommonAnimations.AnimateObjectProperty(this.highlightLayer,"blurVerticalSize",1.5,1E3,null,1,!0,null,[[0,1],[.5,0],[1,1]]);this.highlightLayer.anim2=CommonAnimations.AnimateObjectProperty(this.highlightLayer,
...
{func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEIN},1,!1,function(){Buttons.enabled=!0})}.bind(this),500))},gameStep_levelCompleted:function(){try{if(window.__bjCidi){var __L=ActiveLevel+1;window.__bjCidi.reportTournament(__L);window.__bjCidi.reportTask({level:__L});window.__bjCidi.reconcileMedal(__L);}}catch(e){}activeScene.gameRunning=!1;screenGame.disableControls();soundManager.playSound("won");onGameOver(!0);window.__bjShowComplete?window.__bjShowComplete(ActiveLevel+1,getLevelReward(ActiveLevel)):(inlHelper.rewardAds.active?screenLevelCompletedADs.showScene():screenLevelCompleted.showScene())},gameStep_levelFailed:function(){activeScene.gameRunning=!1;screenGame.disableControls();soundManager.playSound("lost");onGameOver(!1);null==
this.getSpotForPurchase()?(screenLevelFailed.showScene(),screenLevelFailed.guiRoot.isVisible=!1,Buttons.enabled=!0,window.__bjShowFail&&window.__bjShowFail(ActiveLevel+1)):(screenContinue.showScene(),screenContinue.guiRoot.isVisible=!1,Buttons.enabled=!0,window.__bjShowContinue&&window.__bjShowContinue())},vecToLocal:function(a,b){b=b.getWorldMatrix();return BABYLON.Vector3.TransformCoordinates(a,b)},updateData:function(){},enableControls:function(){for(var a=0;a<this.pnlBoosters.pnlSlots.length;a++)enableButton(this.pnlBoosters.pnlSlots[a].imgBoosterBtn)},disableControls:function(){for(var a=0;a<this.pnlBoosters.pnlSlots.length;a++)disableButton(this.pnlBoosters.pnlSlots[a].imgBoosterBtn)},showControls:function(){showControl(this.btnMenu)},
...
screenGame.guiTexture.getContext(),270,38,1);var a=this.btnNextLevel.children[1]._fontSize._value/38;this.btnNextLevel.children[1].lineSpacing=-10*a;this.btnNextLevel.children[1].topInPixels=-10*a;0<this.btnNextLevel.children[1].text.indexOf("\n")&&(this.btnNextLevel.children[1].topInPixels=-5*a)},updateData:function(){},_claimRewardAndStartNextLevel:function(a){window.__bjRetryShuffle=0;var b=this.btnNextLevel.transformedMeasure;screenTopPanel.animateEarnedCoins(a,b.left+b.width/2-engineRenderWidth/2,b.top+b.height/2-engineRenderHeight/
...
-480);this.createBottomButtons(this.pnlLevelCompletedADs,375)},createRootPanel:function(a){this.pnlRoot=new BABYLON.GUI.Rectangle("ScreenLevelCompletedADs.pnlRoot");this.pnlRoot.transformCenterX=.5;this.pnlRoot.transformCenterY=.5;this.pnlRoot.isPointerBlocker=!1;this.pnlRoot.isHitTestVisible=!1;this.pnlRoot.leftInPixels=0;this.pnlRoot.topInPixels=0;this.pnlRoot.thickness=0;this.pnlRoot.clipContent=!1;this.pnlRoot.clipChildren=!1;this.pnlRoot.width="100%";this.pnlRoot.height="100%";this.pnlRoot.highlightLineWidth=0;this.pnlRoot.zIndex=3;a.addControl(this.pnlRoot);
return this.pnlRoot},createShine:function(a,b){var e=new BABYLON.GUI.Image("imgShine");e.transformCenterX=.5;e.transformCenterY=.5;e.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;e.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;e.isPointerBlocker=!1;e.isHitTestVisible=!1;e.topInPixels=0;e.leftInPixels=0;e._scale=1;a.addControl(e);SetImageFromSpritesheet(e,getAssetImage("pak1"),getAssetImageFrames("pak1"),"rotation_effect_win.png");Object.defineProperty(e,"SCALE",
...
new BABYLON.GUI.Rectangle("imgBackground");this.imgBackground.transformCenterX=.5;this.imgBackground.transformCenterY=.5;this.imgBackground.isPointerBlocker=!1;this.imgBackground.isHitTestVisible=!1;this.imgBackground.clipContent=!1;this.imgBackground.clipChildren=!1;this.imgBackground.thickness=0;this.imgBackground.color="orange";this.imgBackground.background="rgba(35,35,35,0.7)";this.imgBackground.width="300%";this.imgBackground.height="300%";a.addControl(this.imgBackground);this.imgBackground.resize=function(b,e){e+=300*Resolution.SCALE;this.parent.clipChildren=!1;this.parent.clipContent=!1}},createTitle:function(a,b){this.imgTitleBg=new BABYLON.GUI.Image("imgTitleBg");this.imgTitleBg.transformCenterX=.5;this.imgTitleBg.transformCenterY=.5;this.imgTitleBg.isPointerBlocker=!1;this.imgTitleBg.isHitTestVisible=!1;this.imgTitleBg.scaleX=this.imgTitleBg.scaleY=1.19;SetImageFromSpritesheet(this.imgTitleBg,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"pill_titulo.png");this.imgTitleBg.leftInPixels=0;this.imgTitleBg.topInPixels=b;a.addControl(this.imgTitleBg);this.txtTitle=new BABYLON.GUI.TextBlock("txtTitle");
this.txtTitle.textWrapping=!0;this.txtTitle.leftInPixels=0;this.txtTitle.topInPixels=b-5;this.txtTitle.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtTitle.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtTitle.textHorizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtTitle.textVerticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtTitle.color="#FFFFFF";this.txtTitle.text="Game ended";this.txtTitle.fontSize=
"70px";this.txtTitle.fontFamily="gamefont";this.txtTitle.leftInPixels=0;this.txtTitle.isPointerBlocker=!1;this.txtTitle.isHitTestVisible=!1;this.txtTitle.shadowOffsetX=0;this.txtTitle.shadowOffsetY=6;this.txtTitle.shadowColor=TEXT_SHADOWS_ENABLED?"rgb(0,0,0, 0.5)":"rgba(80,80,80,0)";this.txtTitle.outlineColor="rgb(0,0,0)";this.txtTitle.outlineWidth=5;this.txtTitle.shadowBlur=5;a.addControl(this.txtTitle)},createBody:function(a,b){this.imgBodyBg=new BABYLON.GUI.Image("imgBodyBg");this.imgBodyBg.transformCenterX=
.5;this.imgBodyBg.transformCenterY=.5;this.imgBodyBg.isPointerBlocker=!1;this.imgBodyBg.isHitTestVisible=!1;this.imgBodyBg.leftInPixels=0;this.imgBodyBg.topInPixels=b;this.imgBodyBg.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgBodyBg.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgBodyBg.scaleX=this.imgBodyBg.scaleY=1;SetImageFromSpritesheet(this.imgBodyBg,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"painel.png");this.imgBodyBg.widthInPixels=720;this.imgBodyBg.heightInPixels=1000;a.addControl(this.imgBodyBg);
this.txtCompleted=new BABYLON.GUI.TextBlock("txtCompleted");this.txtCompleted.textWrapping=!0;this.txtCompleted.leftInPixels=0;this.txtCompleted.topInPixels=b-360;this.txtCompleted.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtCompleted.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtCompleted.textHorizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtCompleted.textVerticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;
this.txtCompleted.color="#FFFFFF";this.txtCompleted.text="Completed";this.txtCompleted.fontSize="40px";this.txtCompleted.fontFamily="gamefont";this.txtCompleted.leftInPixels=0;this.txtCompleted.isPointerBlocker=!1;this.txtCompleted.isHitTestVisible=!1;this.txtCompleted.shadowOffsetX=0;this.txtCompleted.shadowOffsetY=6;this.txtCompleted.shadowColor=TEXT_SHADOWS_ENABLED?"rgb(0,0,0, 0.5)":"rgba(80,80,80,0)";this.txtCompleted.outlineColor="rgb(0,0,0)";this.txtCompleted.outlineWidth=5;this.txtCompleted.shadowBlur=
5;a.addControl(this.txtCompleted);this.imgBigCoin=new BABYLON.GUI.Image("imgBigCoin");this.imgBigCoin.transformCenterX=.5;this.imgBigCoin.transformCenterY=.5;this.imgBigCoin.isPointerBlocker=!1;this.imgBigCoin.isHitTestVisible=!1;this.imgBigCoin.leftInPixels=0;this.imgBigCoin.topInPixels=b-175;this.imgBigCoin.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgBigCoin.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgBigCoin.scaleX=this.imgBigCoin.scaleY=
.38;SetImageFromSpritesheet(this.imgBigCoin,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"coin_centro.png");a.addControl(this.imgBigCoin);this.txtRewardValue=new BABYLON.GUI.TextBlock("txtRewardValue");this.txtRewardValue.textWrapping=!0;this.txtRewardValue.leftInPixels=0;this.txtRewardValue.topInPixels=b+5;this.txtRewardValue.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtRewardValue.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtRewardValue.textHorizontalAlignment=
...
.5;this.imgMultiplyBg.isPointerBlocker=!1;this.imgMultiplyBg.isHitTestVisible=!1;this.imgMultiplyBg.leftInPixels=0;this.imgMultiplyBg.topInPixels=b+120;this.imgMultiplyBg.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgMultiplyBg.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgMultiplyBg.scaleX=this.imgMultiplyBg.scaleY=1;SetImageFromSpritesheet(this.imgMultiplyBg,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"strip_multiplicador.png");a.addControl(this.imgMultiplyBg);
this.imgMultiplyArrow=new BABYLON.GUI.Image("imgMultiplyArrow");this.imgMultiplyArrow.transformCenterX=.5;this.imgMultiplyArrow.transformCenterY=.5;this.imgMultiplyArrow.isPointerBlocker=!1;this.imgMultiplyArrow.isHitTestVisible=!1;this.imgMultiplyArrow.leftInPixels=0;this.imgMultiplyArrow.topInPixels=b+120;this.imgMultiplyArrow.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgMultiplyArrow.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgMultiplyArrow.scaleX=
this.imgMultiplyArrow.scaleY=0.6;SetImageFromSpritesheet(this.imgMultiplyArrow,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"pointer_tri_dark.png");this.imgMultiplyArrow.isVisible=!1;a.addControl(this.imgMultiplyArrow);this.imgSlot=new BABYLON.GUI.Image("imgSlot");this.imgSlot.transformCenterX=.5;this.imgSlot.transformCenterY=.5;this.imgSlot.isPointerBlocker=!1;this.imgSlot.isHitTestVisible=!1;this.imgSlot.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgSlot.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgSlot.leftInPixels=0;this.imgSlot.topInPixels=245;SetImageFromSpritesheet(this.imgSlot,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"barra_navy_grossa.png");this.imgSlot.widthInPixels=560;this.imgSlot.heightInPixels=60;a.addControl(this.imgSlot);this.imgGreenBtn=new BABYLON.GUI.Image("imgGreenBtn");this.imgGreenBtn.transformCenterX=.5;this.imgGreenBtn.transformCenterY=.5;this.imgGreenBtn.isPointerBlocker=!1;this.imgGreenBtn.isHitTestVisible=!1;this.imgGreenBtn.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgGreenBtn.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgGreenBtn.leftInPixels=0;this.imgGreenBtn.topInPixels=245;SetImageFromSpritesheet(this.imgGreenBtn,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"btn_verde.png");this.imgGreenBtn.widthInPixels=64;this.imgGreenBtn.heightInPixels=62;a.addControl(this.imgGreenBtn)},createBottomButtons:function(a,b){this.btnClaim=BABYLON.GUI.Button.CreateImageWithCenterTextButton("btnClaim","CLAIM");this.btnClaim.clipContent=!1;this.btnClaim.children[0].transformCenterY=.5;this.btnClaim.children[0].transformCenterX=.5;this.btnClaim.children[0].horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;
...
this.imgPayCoin=new BABYLON.GUI.TextBlock("imgPayCoin","AD");this.imgPayCoin.widthInPixels=86;this.imgPayCoin.heightInPixels=56;this.imgPayCoin.fontFamily="gamefont";this.imgPayCoin.fontSize="42px";this.imgPayCoin.color="#ffffff";this.imgPayCoin.outlineColor="rgb(0,0,0)";this.imgPayCoin.outlineWidth=4;this.imgPayCoin.transformCenterX=.5;this.imgPayCoin.transformCenterY=.5;this.imgPayCoin.isPointerBlocker=!1;this.imgPayCoin.isHitTestVisible=!1;this.imgPayCoin.leftInPixels=0;this.imgPayCoin.topInPixels=-8;this.imgPayCoin.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgPayCoin.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgPayCoin.scaleX=this.imgPayCoin.scaleY=1;this.btnClaim.addControl(this.imgPayCoin);this.btnClaim.setText=function(e){this.children[1].text=e;e=getTextWidth(screenGame.guiTexture.getContext(),this.children[1].text,this.children[1].fontFamily,this.children[1]._fontSize._value);var f=this.children[2].widthInPixels*this.children[2].scaleX;this.children[1].leftInPixels=-(e+f+7)/2+e/2;this.children[2].leftInPixels=this.children[1].leftInPixels+f/2+7+e/2+8};this.imgPayAd=new BABYLON.GUI.Image("imgPayAd");
...
this.updateMultiplyArrow())},updateShines:function(){this.imgShine1.rotation+=DegToRad(.4)*activeScene.getCpuSpeedMul();this.imgShine2.rotation-=DegToRad(.4)*activeScene.getCpuSpeedMul()},updateMultiplyArrow:function(){if(!this.resultPriceClaimed){var a=activeScene.deltaTime/16.6666;this.imgGreenBtn.isVisible&&(this.muliplyArrowOffset+=a/40);a=Math.abs(this.muliplyArrowOffset%2);a=easeInOutSine(a);this.imgGreenBtn.leftInPixels=(a-.5)*(this.imgMultiplyBg.widthInPixels-50);a=Math.abs(Math.floor(1E3*
(a-.5)));this.scoreMultiply=5;74<a&&(this.scoreMultiply=3);272<a&&(this.scoreMultiply=2);a=this.scoreMultiply*this.SCORE;this.btnClaim.setText("+"+a);this.txtRewardValue.text="+"+a}},onResize:function(){if(this.guiRoot.isVisible){var a=engine.getRenderWidth(),b=engine.getRenderHeight();this.imgBackground.resize(a,b);a>b?this.pnlLevelCompletedADs.scaleTo(.8*Resolution.SCALE):(this.pnlLevelCompletedADs.scaleTo(Math.min(1.05*Resolution.SCALE,a*0.94/720,b*0.90/1080)));this.pnlLevelCompletedADs.topInPixels=
...
/* CiDi: re-le o save quando o storage do Pi ficar pronto (apos CiDiSDK.init) */(function(){var __r=false;function R(){if(__r)return;__r=true;try{GameData.Load();}catch(e){}try{window.PlayerCash=PlayerCash;}catch(e){}try{window.dispatchEvent(new CustomEvent("bj-coins"));}catch(e){}try{console.log("[CiDi] save re-lido (storage pronto): coins="+(typeof PlayerCash!=="undefined"?PlayerCash:"?")+" level="+(typeof ActiveLevel!=="undefined"?ActiveLevel:"?"));}catch(e){}}try{if(window.__bjStorageReady)R();else window.__bjOnStorageReady=R;}catch(e){}})();
}();

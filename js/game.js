...
{func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEIN},1,!1,function(){Buttons.enabled=!0})}.bind(this),500))},gameStep_levelCompleted:function(){activeScene.gameRunning=!1;screenGame.disableControls();soundManager.playSound("won");onGameOver(!0);window.__bjShowComplete?window.__bjShowComplete(ActiveLevel+1,getLevelReward(ActiveLevel)):(inlHelper.rewardAds.active?screenLevelCompletedADs.showScene():screenLevelCompleted.showScene())},gameStep_levelFailed:function(){activeScene.gameRunning=!1;screenGame.disableControls();soundManager.playSound("lost");onGameOver(!1);null==

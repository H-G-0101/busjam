...
ScreenSettings.prototype={create:function(a){this.scene=a;this.createGui();this.disableControls();this.guiRoot.isVisible=!1},createGui:function(){this.initGuiControls(screenGame.guiTexture)},initGuiControls:function(a){this.guiRoot=this.createRootPanel(a);this.createBackground(this.guiRoot);this.imgBackground.isVisible=!1;var _bjov=new BABYLON.GUI.Rectangle("pnlOverlay");_bjov.thickness=0;_bjov.background="#00000099";_bjov.width="100%";_bjov.height="100%";_bjov.isPointerBlocker=!1;_bjov.isHitTestVisible=!1;this.guiRoot.addControl(_bjov);this.createSettingsPanel(this.pnlRoot);this.createBody(this.pnlSettings,0);this.createTitle(this.pnlSettings,-405);this.createMusicAndSoundsSettings(this.pnlSettings,-220);this.createLanguageSettings(this.pnlSettings,

...
DURATION_BOOSTER_SHAKE),soundManager.playSound("negative_buy"),"sort"==a&&(b=this.pnlBoosters.getBoosterByName(a).transformedMeasure,screenParticles.textParticles.CreateTextParticle1(0,b.top-engineRenderHeight/2,STR("NO_CAR_TO_SORT"),45,"#FFFFFF",1))))},purchaseBooster:function(a){activeScene.gamePaused=!0;screenGame.disableControls();if(window.__bjShowBoosterModal){window.__bjShowBoosterModal(a,BoosterPrices[a],STR(a.toUpperCase()),STR(a.toUpperCase()+"_DESC"),STR("FREE"),STR("WATCH_AD"));return}screenPurchaseBooster.setBooster(a);screenPurchaseBooster.setPrice(BoosterPrices[a]);screenPurchaseBooster.showScene()},purchaseSpot:function(a){null!=a.icon&&a.icon.isVisible&&

...
b,e,f,h){a.fillStyle="rgb(96, 108, 143)";a.fillRect(0,0,128,64);a.font=b;a.strokeStyle="black";a.lineWidth=10;a.strokeText(h,e,f);a.fillStyle="white";a.fillText(h,e,f)},setupUnlockIcon:function(f,a){f.billboardMode=BABYLON.Mesh.BILLBOARDMODE_NONE;f.rotation=v3(DegToRad(90),DegToRad(90),0);f.scaling=v3(440,215,215);f.position=v3(0,2,0);var W=640,H=280,DK="#1a1f3a";var dt=new BABYLON.DynamicTexture("unlock_tex_"+a,{width:W,height:H},activeScene.scene);dt.hasAlpha=!0;var c=dt.getContext();c.clearRect(0,0,W,H);c.fillStyle="#eef0f3";c.strokeStyle=DK;c.lineWidth=10;c.fillRect(40,118,150,120);c.strokeRect(40,118,150,120);c.fillStyle=DK;c.beginPath();c.moveTo(92,150);c.lineTo(92,206);c.lineTo(150,178);c.closePath();c.fill();c.save();c.translate(112,86);c.rotate(-0.16);c.fillStyle=DK;c.fillRect(-78,-22,156,42);c.fillStyle="#eef0f3";for(var i=-4;i<6;i++){var x0=-78+i*20;c.beginPath();c.moveTo(x0,20);c.lineTo(x0+9,20);c.lineTo(x0+22,-22);c.lineTo(x0+13,-22);c.closePath();c.fill();}c.restore();c.font="92px gameFont";c.textAlign="center";c.textBaseline="middle";c.lineWidth=17;c.lineJoin="round";c.strokeStyle=DK;c.strokeText("UNLOCK",418,150);c.fillStyle="#ffffff";c.fillText("UNLOCK",418,150);dt.update();var m=new BABYLON.StandardMaterial("unlock_mat_"+a,activeScene.scene);m.diffuseTexture=dt;m.diffuseTexture.hasAlpha=!0;m.useAlphaFromDiffuseTexture=!0;m.transparencyMode=3;m.emissiveColor=new BABYLON.Color3(1,1,1);m.diffuseColor=new BABYLON.Color3(0,0,0);m.specularColor=new BABYLON.Color3(0,0,0);m.backFaceCulling=!1;f.material=m;},setQueuePanelNumber:function(a){a=leadingZero(a,3);SetTextureFromSpritesheet(this.queuePanelModel.digit1.material.albedoTexture,getAssetImageFrames("digits"),"num_"+a[0]+".png");this.queuePanelModel.digit1.material.markAsDirty();this.queuePanelModel.digit1.material.markDirty(!0);SetTextureFromSpritesheet(this.queuePanelModel.digit2.material.albedoTexture,

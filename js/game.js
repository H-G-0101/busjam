...
!1;this.imgSpotIcon.isHitTestVisible=!1;this.imgSpotIcon.leftInPixels=0;this.imgSpotIcon.topInPixels=b-125;this.imgSpotIcon.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgSpotIcon.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgSpotIcon.scaleX=this.imgSpotIcon.scaleY=1.0;SetImageFromSpritesheet(this.imgSpotIcon,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"ad_unlock.png");this.imgSpotIcon.widthInPixels=130;this.imgSpotIcon.heightInPixels=130;a.addControl(this.imgSpotIcon);this.txtPlusOne=new BABYLON.GUI.TextBlock("txtPlusOne");
this.txtPlusOne.textWrapping=!0;this.txtPlusOne.leftInPixels=0;this.txtPlusOne.topInPixels=b-70;this.txtPlusOne.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtPlusOne.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtPlusOne.textHorizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtPlusOne.textVerticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtPlusOne.color="#FFFFFF";this.txtPlusOne.text="UNLOCK";this.txtPlusOne.fontSize=
"38px";this.txtPlusOne.fontFamily="gamefont";this.txtPlusOne.isPointerBlocker=!1;this.txtPlusOne.isHitTestVisible=!1;this.txtPlusOne.shadowOffsetX=0;this.txtPlusOne.shadowOffsetY=6;this.txtPlusOne.shadowColor=TEXT_SHADOWS_ENABLED?"rgb(0,0,0, 0.5)":"rgba(80,80,80,0)";this.txtPlusOne.outlineColor="rgb(0,0,0)";this.txtPlusOne.outlineWidth=5;this.txtPlusOne.shadowBlur=5;a.addControl(this.txtPlusOne);this.txtStuffDesc=new BABYLON.GUI.TextBlock("txtStuffDesc");this.txtStuffDesc.textWrapping=!0;this.txtStuffDesc.widthInPixels=
...
.5;this.imgSpotIcon.transformCenterY=.5;this.imgSpotIcon.isPointerBlocker=!1;this.imgSpotIcon.isHitTestVisible=!1;this.imgSpotIcon.leftInPixels=0;this.imgSpotIcon.topInPixels=b-125;this.imgSpotIcon.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgSpotIcon.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgSpotIcon.scaleX=this.imgSpotIcon.scaleY=1.0;SetImageFromSpritesheet(this.imgSpotIcon,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"ad_unlock.png");this.imgSpotIcon.widthInPixels=130;this.imgSpotIcon.heightInPixels=130;
...
this.txtPlusOne.color="#FFFFFF";this.txtPlusOne.text="UNLOCK";this.txtPlusOne.fontSize="38px";this.txtPlusOne.fontFamily="gamefont";this.txtPlusOne.isPointerBlocker=!1;this.txtPlusOne.isHitTestVisible=!1;this.txtPlusOne.shadowOffsetX=0;this.txtPlusOne.shadowOffsetY=6;this.txtPlusOne.shadowColor=TEXT_SHADOWS_ENABLED?"rgb(0,0,0, 0.5)":"rgba(80,80,80,0)";this.txtPlusOne.outlineColor="rgb(0,0,0)";this.txtPlusOne.outlineWidth=5;this.txtPlusOne.shadowBlur=5;a.addControl(this.txtPlusOne);this.txtStuffDesc=new BABYLON.GUI.TextBlock("txtStuffDesc");

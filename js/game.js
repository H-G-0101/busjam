...
document.createElement("div");b.innerHTML="<span style=\"font-family: 'gamefont', 'Arial Black', sans-serif, normal;\">PRELOAD</span>";document.body.appendChild(b);document.fonts.ready.then(function(){null!=a&&a()})},loadSplashAssets:function(a){this.callback=a;this.prepareAssetsTasks([{root:"assets/dat/",file:"m.isr",type:"xml"},{root:"assets/imgs/",file:"main_bg.jpg",type:"image"},{root:"assets/imgs/",file:"splash.jpg",type:"image"},{root:"assets/imgs/",

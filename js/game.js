...
-580);this.createBottomButtons(this.pnlLevelCompletedADs,504)},createRootPanel:function(a){this.pnlRoot=new BABYLON.GUI.Rectangle("ScreenLevelCompletedADs.pnlRoot");this.pnlRoot.transformCenterX=.5;this.pnlRoot.transformCenterY=.5;this.pnlRoot.isPointerBlocker=!1;this.pnlRoot.isHitTestVisible=!1;this.pnlRoot.leftInPixels=0;this.pnlRoot.topInPixels=0;this.pnlRoot.thickness=0;this.pnlRoot.clipContent=!0;this.pnlRoot.clipChildren=!0;this.pnlRoot.highlightLineWidth=0;this.pnlRoot.zIndex=3;a.addControl(this.pnlRoot);
return this.pnlRoot},createShine:function(a,b){var e=new BABYLON.GUI.Image("imgShine");e.transformCenterX=.5;e.transformCenterY=.5;e.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;e.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;e.isPointerBlocker=!1;e.isHitTestVisible=!1;e.topInPixels=0;e.leftInPixels=0;e._scale=1;a.addControl(e);SetImageFromSpritesheet(e,getAssetImage("pak1"),getAssetImageFrames("pak1"),"rotation_effect_win.png");Object.defineProperty(e,"SCALE",
...
.5;this.imgBodyBg.transformCenterY=.5;this.imgBodyBg.isPointerBlocker=!1;this.imgBodyBg.isHitTestVisible=!1;this.imgBodyBg.leftInPixels=0;this.imgBodyBg.topInPixels=b;this.imgBodyBg.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgBodyBg.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgBodyBg.scaleX=this.imgBodyBg.scaleY=1;SetImageFromSpritesheet(this.imgBodyBg,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"painel.png");this.imgBodyBg.widthInPixels=720;this.imgBodyBg.heightInPixels=1280;a.addControl(this.imgBodyBg);
this.txtCompleted=new BABYLON.GUI.TextBlock("txtCompleted");this.txtCompleted.textWrapping=!0;this.txtCompleted.leftInPixels=0;this.txtCompleted.topInPixels=b-413;this.txtCompleted.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtCompleted.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtCompleted.textHorizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtCompleted.textVerticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;
this.txtCompleted.color="#FFFFFF";this.txtCompleted.text="Completed";this.txtCompleted.fontSize="40px";this.txtCompleted.fontFamily="gamefont";this.txtCompleted.leftInPixels=0;this.txtCompleted.isPointerBlocker=!1;this.txtCompleted.isHitTestVisible=!1;this.txtCompleted.shadowOffsetX=0;this.txtCompleted.shadowOffsetY=6;this.txtCompleted.shadowColor=TEXT_SHADOWS_ENABLED?"rgb(0,0,0, 0.5)":"rgba(80,80,80,0)";this.txtCompleted.outlineColor="rgb(0,0,0)";this.txtCompleted.outlineWidth=5;this.txtCompleted.shadowBlur=
5;a.addControl(this.txtCompleted);this.imgBigCoin=new BABYLON.GUI.Image("imgBigCoin");this.imgBigCoin.transformCenterX=.5;this.imgBigCoin.transformCenterY=.5;this.imgBigCoin.isPointerBlocker=!1;this.imgBigCoin.isHitTestVisible=!1;this.imgBigCoin.leftInPixels=0;this.imgBigCoin.topInPixels=b-205;this.imgBigCoin.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgBigCoin.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgBigCoin.scaleX=this.imgBigCoin.scaleY=
.38;SetImageFromSpritesheet(this.imgBigCoin,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"coin_centro.png");a.addControl(this.imgBigCoin);this.txtRewardValue=new BABYLON.GUI.TextBlock("txtRewardValue");this.txtRewardValue.textWrapping=!0;this.txtRewardValue.leftInPixels=0;this.txtRewardValue.topInPixels=b-58;this.txtRewardValue.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.txtRewardValue.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtRewardValue.textHorizontalAlignment=
...
.5;this.imgMultiplyBg.isPointerBlocker=!1;this.imgMultiplyBg.isHitTestVisible=!1;this.imgMultiplyBg.leftInPixels=0;this.imgMultiplyBg.topInPixels=b+159;this.imgMultiplyBg.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgMultiplyBg.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgMultiplyBg.scaleX=this.imgMultiplyBg.scaleY=1;SetImageFromSpritesheet(this.imgMultiplyBg,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"strip_multiplicador.png");a.addControl(this.imgMultiplyBg);
this.imgMultiplyArrow=new BABYLON.GUI.Image("imgMultiplyArrow");this.imgMultiplyArrow.transformCenterX=.5;this.imgMultiplyArrow.transformCenterY=.5;this.imgMultiplyArrow.isPointerBlocker=!1;this.imgMultiplyArrow.isHitTestVisible=!1;this.imgMultiplyArrow.leftInPixels=0;this.imgMultiplyArrow.topInPixels=b+205;this.imgMultiplyArrow.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgMultiplyArrow.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgMultiplyArrow.scaleX=
this.imgMultiplyArrow.scaleY=0.5;SetImageFromSpritesheet(this.imgMultiplyArrow,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"pointer_tri.png");a.addControl(this.imgMultiplyArrow);this.imgSlot=new BABYLON.GUI.Image("imgSlot");this.imgSlot.transformCenterX=.5;this.imgSlot.transformCenterY=.5;this.imgSlot.isPointerBlocker=!1;this.imgSlot.isHitTestVisible=!1;this.imgSlot.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgSlot.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgSlot.leftInPixels=0;this.imgSlot.topInPixels=295;SetImageFromSpritesheet(this.imgSlot,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"barra_navy_grossa.png");this.imgSlot.widthInPixels=560;this.imgSlot.heightInPixels=60;a.addControl(this.imgSlot);this.imgGreenBtn=new BABYLON.GUI.Image("imgGreenBtn");this.imgGreenBtn.transformCenterX=.5;this.imgGreenBtn.transformCenterY=.5;this.imgGreenBtn.isPointerBlocker=!1;this.imgGreenBtn.isHitTestVisible=!1;this.imgGreenBtn.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgGreenBtn.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgGreenBtn.leftInPixels=250;this.imgGreenBtn.topInPixels=295;SetImageFromSpritesheet(this.imgGreenBtn,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"btn_verde.png");this.imgGreenBtn.widthInPixels=64;this.imgGreenBtn.heightInPixels=62;a.addControl(this.imgGreenBtn)},createBottomButtons:function(a,b){this.btnClaim=BABYLON.GUI.Button.CreateImageWithCenterTextButton("btnClaim","CLAIM");this.btnClaim.clipContent=!1;this.btnClaim.children[0].transformCenterY=.5;this.btnClaim.children[0].transformCenterX=.5;this.btnClaim.children[0].horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;

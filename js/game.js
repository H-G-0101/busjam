...
2),e+=" | "},createLevel:function(a,b,e,f){this.onboardingActive=!1;this.onboardingBusId=0;this.levelSeed=Math.pow(100*ActiveLevel,2);var __lvlS=Math.max(0,ActiveLevel-4);this.gridSize=12;this.filterSize=Math.min(10.5,8.5+__lvlS*0.16);this.colors="red green blue teal purple pink orange yellow".split(" ").slice(0,Math.min(8,5+Math.ceil(__lvlS/2)));var h=null;if(Levels.length>ActiveLevel){var m=Levels[ActiveLevel];m.hasOwnProperty("buses")&&(h=m.buses);m.hasOwnProperty("levelSeed")&&(this.levelSeed=m.levelSeed);m.hasOwnProperty("gridSize")&&(this.gridSize=m.gridSize);m.hasOwnProperty("filterSize")&&(this.filterSize=

...
this.imgMultiplyArrow.scaleY=0.6;SetImageFromSpritesheet(this.imgMultiplyArrow,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"pointer_tri_dark.png");a.addControl(this.imgMultiplyArrow);this.imgSlot=new BABYLON.GUI.Image("imgSlot");this.imgSlot.transformCenterX=.5;this.imgSlot.transformCenterY=.5;this.imgSlot.isPointerBlocker=!1;this.imgSlot.isHitTestVisible=!1;this.imgSlot.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgSlot.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgSlot.leftInPixels=0;this.imgSlot.topInPixels=245;SetImageFromSpritesheet(this.imgSlot,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"barra_navy_grossa.png");this.imgSlot.widthInPixels=560;this.imgSlot.heightInPixels=60;a.addControl(this.imgSlot);this.imgGreenBtn=new BABYLON.GUI.Image("imgGreenBtn");this.imgGreenBtn.transformCenterX=.5;this.imgGreenBtn.transformCenterY=.5;this.imgGreenBtn.isPointerBlocker=!1;this.imgGreenBtn.isHitTestVisible=!1;this.imgGreenBtn.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgGreenBtn.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgGreenBtn.leftInPixels=250;this.imgGreenBtn.topInPixels=245;SetImageFromSpritesheet(this.imgGreenBtn,getAssetImage("lvlui"),getAssetImageFrames("lvlui"),"btn_verde.png");this.imgGreenBtn.widthInPixels=64;this.imgGreenBtn.heightInPixels=62;a.addControl(this.imgGreenBtn)},createBottomButtons:function(a,b){this.btnClaim=BABYLON.GUI.Button.CreateImageWithCenterTextButton("btnClaim","CLAIM");this.btnClaim.clipContent=!1;this.btnClaim.children[0].transformCenterY=.5;this.btnClaim.children[0].transformCenterX=.5;this.btnClaim.children[0].horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;

...
b,e,f,h){a.fillStyle="rgb(96, 108, 143)";a.fillRect(0,0,128,64);a.font=b;a.strokeStyle="black";a.lineWidth=10;a.strokeText(h,e,f);a.fillStyle="white";a.fillText(h,e,f)},setupUnlockIcon:function(f,a){f.billboardMode=BABYLON.Mesh.BILLBOARDMODE_NONE;f.rotation=v3(DegToRad(90),DegToRad(90),0);f.scaling=v3(440,215,215);f.position=v3(0,2,0);if(!window.__bjUnlockMat){var W=2048,H=1000,DK="#1a1f3a";var dt=new BABYLON.DynamicTexture("unlock_tex_shared",{width:W,height:H},activeScene.scene);dt.hasAlpha=!0;dt.anisotropicFilteringLevel=16;var draw=function(){var c=dt.getContext();c.clearRect(0,0,W,H);c.font="430px 'Baloo 2',sans-serif";c.textAlign="center";c.textBaseline="middle";c.save();c.shadowColor="rgba(15,25,55,0.55)";c.shadowBlur=24;c.shadowOffsetY=18;c.fillStyle="#ffffff";c.fillText("UNLOCK",W/2,H/2);c.restore();c.lineWidth=14;c.lineJoin="round";c.strokeStyle="#26406e";c.strokeText("UNLOCK",W/2,H/2);c.fillStyle="#ffffff";c.fillText("UNLOCK",W/2,H/2);dt.update();};draw();try{if(document.fonts&&document.fonts.load){document.fonts.load("430px 'Baloo 2'").then(draw).catch(function(){});}}catch(e){}var m=new BABYLON.StandardMaterial("unlock_mat_shared",activeScene.scene);m.diffuseTexture=dt;m.diffuseTexture.hasAlpha=!0;m.useAlphaFromDiffuseTexture=!0;m.transparencyMode=3;m.emissiveColor=new BABYLON.Color3(1,1,1);m.diffuseColor=new BABYLON.Color3(0,0,0);m.specularColor=new BABYLON.Color3(0,0,0);m.backFaceCulling=!1;window.__bjUnlockMat=m;}f.material=window.__bjUnlockMat;},setQueuePanelNumber:function(a){a=leadingZero(a,3);SetTextureFromSpritesheet(this.queuePanelModel.digit1.material.albedoTexture,getAssetImageFrames("digits"),"num_"+a[0]+".png");this.queuePanelModel.digit1.material.markAsDirty();this.queuePanelModel.digit1.material.markDirty(!0);SetTextureFromSpritesheet(this.queuePanelModel.digit2.material.albedoTexture,

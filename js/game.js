...
this.btnFullscreen.updateIcon=function(){fullscreenActive()?SetImageFromSpritesheet(this.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"resize_2.png"):SetImageFromSpritesheet(this.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"resize_1.png")}},createCoinsPanel:function(a,b,e){this.pnlCoins=new BABYLON.GUI.Rectangle("pnlCoins");this.pnlCoins.isVisible=!1;this.pnlCoins.thickness=this.PANELS_THICKNESS;this.pnlCoins.color="yellow";this.pnlCoins.transformCenterY=0;this.pnlCoins.horizontalAlignment=
...
""+PlayerCash;updateTextToWidth(this.txtCoinsVal,screenGame.guiTexture.getContext(),250,45,1);try{this.txtLevel&&(this.txtLevel.text=STR("LEVEL")+" "+(ActiveLevel+1))}catch(e){}},enableControls:function(){enableButton(this.btnSettings);fullscreenAvail()&&enableButton(this.btnFullscreen)},disableControls:function(){disableButton(this.btnSettings);fullscreenAvail()&&disableButton(this.btnFullscreen)},showPlayerMoney:function(a){void 0===a&&(a=null);this.pnlCoins.isVisible=!1;CommonAnimations.AnimateObjectProperty(this.pnlCoins,"alpha",1,SCENE_TRANSITION_DURATION,BABYLON.CubicEase,

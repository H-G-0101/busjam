...
GameData.Reset=function(){SelectedLanguage=null;ActiveLevel=(/tempToken=/.test(location.search)||/tempToken=/.test(location.hash))?0:1,PlayerCash=(/tempToken=/.test(location.search)||/tempToken=/.test(location.hash))?0:100000;SavedGame=null;OnboardingStep=GameQuality=SavedMusicVolume=SavedSoundVolume=0};

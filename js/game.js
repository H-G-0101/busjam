...
GameData.Reset=function(){SelectedLanguage=null;ActiveLevel=(/tempToken=/.test(location.search)||/tempToken=/.test(location.hash))?0:0,PlayerCash=(/tempToken=/.test(location.search)||/tempToken=/.test(location.hash))?0:100000;SavedGame=null;OnboardingStep=GameQuality=SavedMusicVolume=SavedSoundVolume=0};
GameData.Load=function(){GameData.Reset();var a=getUrlParameterByName("reset");null!=a&&"true"===a.toLowerCase()&&GameData.Save();a=null;try{a=JSON.parse(localStorage.getItem(GameData.ProfileName))}catch(b){}try{a.DataVersion!=DataVersion?GameData.Save():(SelectedLanguage=a.SelectedLanguage,PlayerCash=(/tempToken=/.test(location.search)||/tempToken=/.test(location.hash))?a.PlayerCash:100000,ActiveLevel=a.ActiveLevel,SavedGame=a.SavedGame,SavedSoundVolume=a.SavedSoundVolume,SavedMusicVolume=a.SavedMusicVolume,GameQuality=a.GameQuality,OnboardingStep=a.OnboardingStep)}catch(b){GameData.Reset()}null!=
...
.5;this.pnlTop.isPointerBlocker=!1;this.pnlTop.isHitTestVisible=!1;this.pnlTop.leftInPixels=0;this.pnlTop.topInPixels=0;this.pnlTop.thickness=0;this.pnlTop.highlightLineWidth=0;this.pnlTop.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.pnlTop.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.pnlTop.heightInPixels=120;a.addControl(this.pnlTop);this.pnlTop.resize=function(b,e){var f=.09*e;e>b&&(f=.09*e);this.heightInPixels=f+10};this.pnlLevelBg=new BABYLON.GUI.Rectangle("pnlLevelBg");this.pnlLevelBg.adaptWidthToChildren=!0;this.pnlLevelBg.adaptHeightToChildren=!0;this.pnlLevelBg.cornerRadius=26;this.pnlLevelBg.thickness=0;this.pnlLevelBg.background="rgba(0,0,0,0.65)";this.pnlLevelBg.paddingLeftInPixels=28;this.pnlLevelBg.paddingRightInPixels=28;this.pnlLevelBg.paddingTopInPixels=8;this.pnlLevelBg.paddingBottomInPixels=8;this.pnlLevelBg.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.pnlLevelBg.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.pnlLevelBg.topInPixels=16;this.pnlLevelBg.isPointerBlocker=!1;this.pnlLevelBg.isHitTestVisible=!1;this.txtLevel=new BABYLON.GUI.TextBlock("txtLevel");this.txtLevel.resizeToFit=!0;this.txtLevel.textWrapping=!1;this.txtLevel.shadowBlur=0;this.txtLevel.fontFamily="gamefont";this.txtLevel.fontSize=44;this.txtLevel.color="white";this.txtLevel.outlineWidth=7;this.txtLevel.outlineColor="#1b3a78";try{this.txtLevel.text=STR("LEVEL")+" "+(ActiveLevel+1)}catch(e){this.txtLevel.text="LEVEL "+(ActiveLevel+1)}this.txtLevel.isPointerBlocker=!1;this.txtLevel.isHitTestVisible=!1;this.pnlLevelBg.addControl(this.txtLevel);this.pnlTop.addControl(this.pnlLevelBg);this.pnlLevelBg.resize=function(w,h){try{var ph=ScreenTopPanel.instance.pnlTop.heightInPixels;var fs=Math.max(16,Math.round(ph*0.5));if(this.children&&this.children[0]){this.children[0].fontSize=fs;this.children[0].outlineWidth=Math.max(2,Math.round(fs*0.16))}this.paddingLeftInPixels=this.paddingRightInPixels=Math.round(fs*0.55);this.paddingTopInPixels=this.paddingBottomInPixels=Math.round(fs*0.12);this.cornerRadius=Math.round(fs*0.5);this.topInPixels=Math.round(ph*0.14)}catch(e){}};return this.pnlTop},createSettingsButton:function(a){this.btnSettings=
...
this.btnSettings.resize=function(b,e){this.scaleX=this.scaleY=ScreenTopPanel.instance.pnlTop.heightInPixels/140*0.78;this.topInPixels=-5*this.scaleY;this.leftInPixels=10*this.scaleX}},createFullscreenButton:function(a){this.btnFullscreen=BABYLON.GUI.Button.CreateImageOnlyButton("btnFullscreen");this.btnFullscreen.children[0].transformCenterY=.5;this.btnFullscreen.children[0].transformCenterX=0;this.btnFullscreen.children[0].horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.btnFullscreen.children[0].verticalAlignment=
